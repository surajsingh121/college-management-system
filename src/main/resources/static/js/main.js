...
console.log('%c🎓 College Management System', 'font-size: 20px; font-weight: bold; color: #6366f1;');
console.log('%cWelcome! This is a modern 3D UI experience.', 'font-size: 14px; color: #64748b;');
